...
{
    public sealed class DsBindComboBoxCellHandler : CellHandler<swc.DataGridComboBoxColumn, DsBindComboBoxCell, DsBindComboBoxCell.ICallback>, DsBindComboBoxCell.IHandler
    {
        ...
        {
            public DsBindComboBoxCellHandler Handler { get; set; }
        ...
        struct Item
        {
            readonly DsBindComboBoxCellHandler handler;
            ...
            public Item(DsBindComboBoxCellHandler handler, object value)
            {
